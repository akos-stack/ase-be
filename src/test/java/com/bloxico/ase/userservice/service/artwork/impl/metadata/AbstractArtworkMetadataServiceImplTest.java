...
public abstract class AbstractArtworkMetadataServiceImplTest extends AbstractSpringTest {
    ...
    public void updateArtworkMetadata_notFound() {
        ...
        var metadata2 = utilArtworkMetadata.savedArtworkMetadataDto(getType(), APPROVED);
        assertEquals(
                utilArtworkMetadata.findArtworkMetadataDtoByStatus(getType(), PENDING), null);
    }
    ...
    public void searchApprovedArtworkMetadata_nullName() {
        ...
        assertThat(
                ...
                allOf(not(hasItems(metadata1, metadata2))));
    }
