...
public interface UserPasswordApi {
    ...
    String FORGOT_PASSWORD_ENDPOINT = OLD + "/user/passwordForgot";
    String UPDATE_FORGOTTEN_PASSWORD_ENDPOINT = OLD + "/user/passwordForgotUpdate";
    String UPDATE_PASSWORD_ENDPOINT = OLD + "/user/passwordUpdate";
    String FORGOT_PASSWORD_TOKEN_RESEND_ENDPOINT = OLD + "/user/passwordTokenResend";
    String SET_PASSWORD_ENDPOINT = OLD + "/user/passwordSet";
