...
public interface UserRegistrationApi {
    ...
    String REGISTRATION_ENDPOINT = OLD + "/user/registration";
    String REGISTRATION_CONFIRMATION_ENDPOINT = OLD + "/user/registrationConfirm";
    String REGISTRATION_TOKEN_REFRESH_ENDPOINT = OLD + "/user/registrationTokenRefresh";
    String REGISTRATION_TOKEN_RESEND_ENDPOINT = OLD + "/user/registrationTokenResend";
    String REGISTRATION_PAGE_DATA_ENDPOINT = OLD + "/user/registrationData";
